...
export class Migration1765221631934 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "favs_artists" DROP CONSTRAINT "favs_artists_artistid_fkey"`,
    );
    await queryRunner.query(
      `ALTER TABLE "favs_artists" DROP CONSTRAINT "favs_artists_favid_fkey"`,
    );
    await queryRunner.query(
      `ALTER TABLE "favs_albums" DROP CONSTRAINT "favs_albums_albumid_fkey"`,
    );
    await queryRunner.query(
      `ALTER TABLE "favs_albums" DROP CONSTRAINT "favs_albums_favid_fkey"`,
    );
    await queryRunner.query(
      `ALTER TABLE "favs_tracks" DROP CONSTRAINT "favs_tracks_trackid_fkey"`,
    );
    await queryRunner.query(
      `ALTER TABLE "favs_tracks" DROP CONSTRAINT "favs_tracks_favid_fkey"`,
    );
    await queryRunner.query(
      `ALTER TABLE "favs_artists" ADD CONSTRAINT "PK_967332d60dc9bc64d3e3198fc6b" PRIMARY KEY ("favId", "artistId")`,
    );
    await queryRunner.query(
      `ALTER TABLE "favs_albums" ADD CONSTRAINT "PK_4ef6e5adf1218448adc31434375" PRIMARY KEY ("favId", "albumId")`,
    );
    await queryRunner.query(
      `ALTER TABLE "favs_tracks" ADD CONSTRAINT "PK_5b35195f43e0a5cf3a321e46c77" PRIMARY KEY ("favId", "trackId")`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "favs_artists" ALTER COLUMN "favId" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "favs_artists" ALTER COLUMN "artistId" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "favs_albums" ALTER COLUMN "favId" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "favs_albums" ALTER COLUMN "albumId" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "favs_tracks" ALTER COLUMN "favId" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "favs_tracks" ALTER COLUMN "trackId" SET NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "favs_tracks" ALTER COLUMN "trackId" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "favs_tracks" ALTER COLUMN "favId" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "favs_albums" ALTER COLUMN "albumId" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "favs_albums" ALTER COLUMN "favId" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "favs_artists" ALTER COLUMN "artistId" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "favs_artists" ALTER COLUMN "favId" DROP NOT NULL`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "favs_tracks" DROP CONSTRAINT "PK_5b35195f43e0a5cf3a321e46c77"`,
    );
    await queryRunner.query(
      `ALTER TABLE "favs_albums" DROP CONSTRAINT "PK_4ef6e5adf1218448adc31434375"`,
    );
    await queryRunner.query(
      `ALTER TABLE "favs_artists" DROP CONSTRAINT "PK_967332d60dc9bc64d3e3198fc6b"`,
    );
    await queryRunner.query(
      `ALTER TABLE "favs_tracks" ADD CONSTRAINT "favs_tracks_favid_fkey" FOREIGN KEY ("favId") REFERENCES "favs"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "favs_tracks" ADD CONSTRAINT "favs_tracks_trackid_fkey" FOREIGN KEY ("trackId") REFERENCES "tracks"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "favs_albums" ADD CONSTRAINT "favs_albums_favid_fkey" FOREIGN KEY ("favId") REFERENCES "favs"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "favs_albums" ADD CONSTRAINT "favs_albums_albumid_fkey" FOREIGN KEY ("albumId") REFERENCES "albums"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "favs_artists" ADD CONSTRAINT "favs_artists_favid_fkey" FOREIGN KEY ("favId") REFERENCES "favs"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "favs_artists" ADD CONSTRAINT "favs_artists_artistid_fkey" FOREIGN KEY ("artistId") REFERENCES "artists"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "tracks" ADD CONSTRAINT "tracks_albumid_fkey" FOREIGN KEY ("albumId") REFERENCES "albums"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "tracks" ADD CONSTRAINT "tracks_artistid_fkey" FOREIGN KEY ("artistId") REFERENCES "artists"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(

...
export class Migration1765650830502 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "login" text NOT NULL, "password" text NOT NULL, "version" integer NOT NULL DEFAULT '1', "createdAt" bigint NOT NULL, "updatedAt" bigint NOT NULL, CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "tracks" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" text NOT NULL, "artistId" uuid, "albumId" uuid, "duration" numeric NOT NULL, CONSTRAINT "PK_242a37ffc7870380f0e611986e8" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "favs" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), CONSTRAINT "PK_2fde25c80bd089c0fa0e7986409" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "favs_artists" ("favId" uuid NOT NULL, "artistId" uuid NOT NULL, CONSTRAINT "PK_967332d60dc9bc64d3e3198fc6b" PRIMARY KEY ("favId", "artistId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "favs_albums" ("favId" uuid NOT NULL, "albumId" uuid NOT NULL, CONSTRAINT "PK_4ef6e5adf1218448adc31434375" PRIMARY KEY ("favId", "albumId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "favs_tracks" ("favId" uuid NOT NULL, "trackId" uuid NOT NULL, CONSTRAINT "PK_5b35195f43e0a5cf3a321e46c77" PRIMARY KEY ("favId", "trackId"))`);
